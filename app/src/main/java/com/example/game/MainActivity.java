...
public class MainActivity extends AppCompatActivity {
    ...
    int frameImage,pawInFrameImage,topImage,emptyImage;
    int currentScore=0;
    int bestScore;
    ...
    private void intiGame()
    {
        ...
        //row 3
        rockLocationRow3=2;
        iv_32.setImageResource(topImage);
    ...
    private void setRockLocation(int place,int row)
    {
        ...
        if (row==3)
        {
            ...
            {
                case 1:
                    iv_31.setImageResource(topImage);
                    break;
                case 2:
                    iv_32.setImageResource(topImage);
                    break;
                case 3:
                    iv_33.setImageResource(topImage);
                    break;
            }
        }
    ...
    {
        frameImage=R.drawable.ic_fram;
        pawInFrameImage=R.drawable.ic_paw_frame;
        topImage=R.drawable.ic_top;
